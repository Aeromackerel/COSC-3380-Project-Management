...
<?php
	...
	// Include DB connection
 	...
 	else if (isset($_POST['submitChanges']))
 	{
 		...
 		$groupName = $_POST['groupCreate'];
 		$groupManagerId = $tempUserID;

 		$sqlGroupCreate = "INSERT INTO Groups(groupManagerId, projectId, groupName, deleteFlagStatus) VALUES ($groupManagerId, $projectId, '$groupName', 0)";

		$conn->query($sqlGroupCreate);

		$groupId = $conn->lastInsertId();

 		$sqlGroupUsers = "INSERT INTO GroupsUsers(groupId, employeeId) VALUES ($groupId, $tempUserID)";
 		
 		$conn->query($sqlGroupUsers);
